/*
вводный коментарий
Знай, что ты заставляешь меня писать самую вроде бы нужную, но на деле бесполезную вещь. Это коментарии)))
елси прям что то совсем не понятно, то найди меня у старого дуба на 3 сутки после дня дурина)))
документация в формате javadoc лежит в папочке, если будешь менять что то, дам гайд как сделать
1. navigate
2. Search everyWhere
3. Пишешь javadoc в поиске
4. Тык на generate javadoc
5. Дальше сам разберешься, мне ленть говорить))
*/
package com.company;
